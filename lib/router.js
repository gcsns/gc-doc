...
class Router {
    static initialize(app, config, container, allowedOrigin, errorResponseKeys) {
        ...
        if (config.enableDocumentation) {
            ...
            const spec = (0, routing_controllers_openapi_1.routingControllersToSpec)(storage, config, Object.assign(Object.assign({}, config.documentationParameters), { components: Object.assign(Object.assign({}, config.documentationParameters.components), { schemas: Object.assign(Object.assign({}, (_a = config.documentationParameters.components) === null || _a === void 0 ? void 0 : _a.schemas), schemas) }) }));
